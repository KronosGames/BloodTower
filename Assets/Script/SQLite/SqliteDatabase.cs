...
public class SqliteDatabase
{
	...
	{
        pathDB = System.IO.Path.Combine(Application.persistentDataPath + "/" + FOLDER_NAME, dbName);

		//original path
        string sourcePath = System.IO.Path.Combine(Application.streamingAssetsPath + "/" + FOLDER_NAME, dbName);

        if (!System.IO.Directory.Exists(Application.persistentDataPath + "/" + FOLDER_NAME))
        {
            System.IO.Directory.CreateDirectory(Application.persistentDataPath + "/" + FOLDER_NAME);
        }
